...
//    private String results;
    ...
    private static final String BASE_URL = "http://192.168.0.7:8080/M3/web/";
    ...
    public String addPerson(String[] details) {
        ...
        Person person = new Person(details[0], details[1], details[2].charAt(0), sqlStartDate, details[4], details[5], Integer.parseInt(details[6]));
//        Gson gson = new Gson();
